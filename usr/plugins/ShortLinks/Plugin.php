...
class ShortLinks_Plugin implements Typecho_Plugin_Interface
{
    ...
    public static function activate()
    {
        ...
        Typecho_Plugin::factory('Mirages_Plugin')->contentEx2 =  array('ShortLinks_Plugin', 'replace');
        Typecho_Plugin::factory('Mirages_Plugin')->excerptEx2 =  array('ShortLinks_Plugin', 'replace');
